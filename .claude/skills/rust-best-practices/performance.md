...
### Error Handling
- **[Option handling](error-handling.md#1-understanding-option-types)** - Type-safe iteration patterns
- **[expect vs unwrap](error-handling.md#3-expect-vs-unwrap-vs--decision-guide)** - Error handling in loops

### Fundamentals
- **[Tracing subscribers](fundamentals.md#tracing-subscribers)** - Logging performance
- **[Duplicated logic](fundamentals.md#duplicated-logic)** - DRY principle

### Type Safety
- **[Enums vs Strings](type-safety.md#3-using-enums-for-fixed-value-sets)** - Enum performance benefits
- **[HashMap optimization](type-safety.md)** - Type-safe collections
