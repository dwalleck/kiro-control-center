...
### Error Handling
- **[Option handling](error-handling.md#1-understanding-option-types)** - Path operations return Option
- **[Path footguns](error-handling.md#2-common-footgun-path-operations)** - Common mistakes with Path methods
...
### Best Practices
- **[CLI user feedback](fundamentals.md#cli-user-feedback)** - Inform users about file operations
- **[Error messages](error-handling.md#3-expect-vs-unwrap-vs--decision-guide)** - Using .context() for clear errors
