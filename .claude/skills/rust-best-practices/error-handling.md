...
### Type Safety
- **[Validation Patterns](type-safety.md)** - Moving from strings to type-safe code
- **[Immediate Validation](type-safety.md#immediate-validation)** - Validating inputs early
